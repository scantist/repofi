...
export default function AiButton({ children }: { children: React.ReactNode }) {
  ...
  return (
    <button
      type={"button"}
      className="group relative rounded-full cursor-pointer bg-gradient-to-r from-blue-300/30 via-blue-500/30 via-20% to-purple-700/30 p-1 text-white transition-transform hover:scale-110 active:scale-105"
      onMouseEnter={() => setIsHovering(true)}
      onMouseLeave={() => setIsHovering(false)}
    >
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-300 via-blue-500 via-20% to-purple-700 px-4 py-2 text-white">

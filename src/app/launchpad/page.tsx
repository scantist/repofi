        ...
        <div className={"flex w-full flex-col md:flex-row items-center justify-between gap-8"}>
          <div className={"flex flex-col"}>
            ...
            <div className={"w-full md:max-w-2/3"}>
              Welcome to the REPO Protocol Launchpad. Vote on the best biotech DAOs to join the ecosystem, and participate in bioDAO token auctions. Discover what&#39;s happening
              in the REPO Protocol ecosystem below!
            </div>
          </div>

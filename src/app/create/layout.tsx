            ...
            <CardWrapper contentClassName={"bg-card"}>
              <div className={"flex flex-col gap-y-5 px-11 py-10"}>
                ...
                <div className={"text-md font-thin text-gray-400"}>
                  ...
                  your DAO&#39;s ERC20 tokens on a bonding curve via REPO
                  Protocol encouraging early adopters to participate. Your DAO
                  agent will autonomously engage with the community via the
                  message board, fostering a dynamic and interactive funding
                  process.
                </div>
                <div className={"text-md font-thin text-gray-400"}>
                  Capabilities
                ...
                <div className={"text-md font-thin text-gray-400"}>
                  Upon successful funding and reaching the launch point, your
                  DAO will transcend into a fully-featured entity. Unlock new
                  capabilities and see your token listed on Uniswap V2 on the
                  Base network, enabling broader trading and liquidity.
                </div>
                <div className={"text-md font-thin text-gray-400"}>
                  Capabilities
                </div>

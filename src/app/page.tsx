  ...
  return <div className={"mt-10 min-h-full"}>
    <BannerWrapper className={"flex w-full flex-col pb-20"}>
      ...
      >
        ...
        <div className={"max-w-3xl flex flex-col md:flex-row justify-between mt-6 py-7 px-4 md:px-8 rounded-lg bg-secondary"}>
          ...
          <div className={"flex flex-col gap-2 mb-4 md:mb-0 md:pl-4 border-t-1 md:border-t-0 md:border-l-1 border-white pt-4 md:pt-0"}>
          ...
          <div className={"flex flex-col gap-2 md:pl-4 border-t-1 md:border-t-0 md:border-l-1 border-white pt-4 md:pt-0"}>

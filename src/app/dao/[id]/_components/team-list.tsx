          ...
          <CardWrapper key={`ccc-${item}`}>
            <div className={"flex flex-col p-6 gap-4"}>
              <div className={"flex flex-row gap-6"}>
                <img src={"https://storage.googleapis.com/repofi/launchpad/avatar/1741621897031_85936f2e95.png"} className={"rounded-full size-16"} />
              ...
              <div className={"mt-2 text-white/50"}>Over the course of the last decade, first as aa graduate student at Harvard University in the Departmen...</div>
              <div className={"w-full text-right"}>Read More</div>
            </div>
          </CardWrapper>
        ))}
        <CardWrapper>

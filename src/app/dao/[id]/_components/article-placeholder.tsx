    ...
    <div className={"my-20"}>
      ...
      <div className={"pt-10 relative justify-center text-center"}>
        <div className={"absolute top-52 flex justify-center items-center w-full text-lg md:text-2xl font-bold z-10"}>
          <a href={`/dao/${id}/edit/list`} className={"bg-primary px-4 py-2 rounded-lg transition-transform transform hover:scale-105 hover:bg-primary-dark hover:shadow-lg"}>
            Config article list title and content
          </a>
        </div>

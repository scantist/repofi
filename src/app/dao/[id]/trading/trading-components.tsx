    ...
    return (
      <div className="absolute -inset-2 z-30 flex flex-col items-center justify-center gap-6 bg-background/90 px-8 backdrop-blur">
        ...
        <div className="flex items-center justify-center gap-8 pb-8">
          <div className="animate-swap-in flex size-16 overflow-clip rounded-full border border-primary/50 bg-background relative">
            {sendingToken.icon}
          </div>
          <div className="animate-swap-out size-16 overflow-clip rounded-full border border-primary/50 bg-background relative">
            {receivingToken.icon}
          </div>
        </div>
    ...
    return (
      <div className="absolute -inset-2 z-30 flex flex-col items-center justify-center gap-4 bg-background/90 px-8 backdrop-blur">
        <div className="flex items-center justify-center">
          <div className="flex size-16 translate-x-2 overflow-clip rounded-full border border-primary/50 bg-background relative">
            {sendingToken.icon}
          </div>
          <div className="size-16 -translate-x-2 overflow-clip rounded-full border border-primary/50 bg-background relative">
            {receivingToken.icon}
          </div>
        </div>
        <p className="text pb-2 pt-4 text-center font-medium text-foreground">
          {successText}
        </p>
